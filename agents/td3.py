...
class Actor(nn.Module):
    def __init__(self, state_dim, action_dim, max_action, h_dim=256, min_action=-1.0):
...
class TD3(object):
    def __init__(self, state_dim, action_dim, max_action, min_action=-1.0, h_dim=256, tau=0.005, device='cuda'):
        self.actor = Actor(state_dim, action_dim, max_action, h_dim, min_action).to(device)
        self.actor_target = Actor(state_dim, action_dim, max_action, h_dim, min_action).to(device)
